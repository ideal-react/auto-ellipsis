...
var AutoEllipsis = (function (_React$Component) {
	...
	function AutoEllipsis() {
		...
		_get(Object.getPrototypeOf(_AutoEllipsis.prototype), 'constructor', this).apply(this, arguments);
	}
	...
	_createClass(AutoEllipsis, [{
		...
		value: function render() {
			...
			return _react2['default'].createElement(tag, props, content);
		}
	}], [{
		key: 'propTypes',
		value: {
			...
			addTitle: _react2['default'].PropTypes.bool,
	...
	AutoEllipsis = (0, _reactCssModules2['default'])(_autoEllipsisCss2['default'], { errorWhenNotFound: process.env.NODE_ENV !== 'test' })(AutoEllipsis) || AutoEllipsis;
	return AutoEllipsis;
